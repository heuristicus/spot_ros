...
class TestGraphNavUtilShortCode(unittest.TestCase):
    def test_id_to_short_code(self):
        self.assertEquals(graph_nav_util.id_to_short_code("AB-CD-EF"), "AC", "AC!=AC")
        self.assertEquals(graph_nav_util.id_to_short_code("AB-CD-EF-1"), "AC", "AC!=AC")
...
class TestGraphNavUtilUpdateWaypointsEdges(unittest.TestCase):
    ...
    def test_empty_graph(self):
        ...
        self.assertEquals(len(self.graph.edges), 0, "Empty graph should have 0 edges")
    ...
    def test_one_waypoint(self):
        ...
        self.assertEquals(len(self.edges), 0, "Edges should have 0 entries")
        self.assertEquals(len(self.name_to_id), 1, "Name to id should have 1 entry")
        self.assertEquals(
    ...
    def test_two_waypoints_with_edge(self):
        ...
        self.assertEquals(len(self.edges), 1, "Edges should have 1 entry")
        self.assertEquals(
            self.edges["DE"][0], "ABCDE", "Edges should point to the correct waypoint"
        )
        self.assertEquals(len(self.name_to_id), 2, "Name to id should have 2 entries")
        self.assertEquals(self.name_to_id["Node1"], "ABCDE", "Name to id entry, ABCDE")
        self.assertEquals(self.name_to_id["Node2"], "DE", "Name to id entry, DE")
